				<cfajaxproxy bind="javascript:showHistory({myGrid.clientid})" />
				...
				<script>
					...
					<cfform name="myForm">
					<cfgrid format="html" name="myGrid" bind="cfc:viewer.whosonProxy.WhosOnlineStats({cfgridpage},{cfgridpagesize},{cfgridsortcolumn},{cfgridsortdirection})" pagesize="10" selectmode="browse" striperows="true" autowidth="true">
